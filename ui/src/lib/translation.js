export default {
  ...
  es: {
    ...
    loginFailed: "Error al iniciar sesión. Verifique sus credenciales e intente nuevamente",
    username: "Nombre de usuario / correo electrónico",
    usernameNotValid: "El nombre de usuario debe tener más de 3 caracteres y no puede contener espacios",
    password: "Contraseña",
    passwordNotValid: "La contraseña debe tener al menos 8 caracteres",
    login: "Iniciar sesión",
    loggingIn: "Iniciando sesión...",
    alreadyLogin: "¿Ya ha iniciado sesión?",
    myCourses: "Mis Cursos",
    inProgress: "En Progreso",
    nextLesson: "Siguiente Lección",
    summary: "Resumen",
    downloads: "Descargas",
    noCourseAssigned: "¡No se le ha asignado ningún curso!",
    courseAssignedCheck: "Los cursos asignados a usted aparecerán aquí, por favor revise esta página de vez en cuando para asegurarse de que nunca se pierda un curso.",
    view: "Ver",
    ...
    inProgress: "En Progreso",
    courseAssigned: "Curso asignado a usted",
    coursesAssigned: "Cursos asignados a usted",
